---
# Full-width layout. Used on EVERY page so the left gutter is identical
# site-wide — a heading on one tab lines up with the heading on the next.
# The default article layout's ~800px column left large empty gutters beside
# the card grids and lists these pages mostly contain. Blog uses it too: the
